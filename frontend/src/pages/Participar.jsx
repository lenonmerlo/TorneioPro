  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] text-center px-4">
      <div className="bg-white/90 rounded-xl p-8 shadow-xl max-w-md w-full space-y-6">
        ...
        <h3 className="text-xl font-bold text-blue-800">Bem-vindo(a). Participe do Torneio EVPC </h3>
        ...
        <div className="grid gap-3">
          ...
          <Link to="/inscricao-oficial?tipo=dupla" className="bg-yellow-400 text-blue-900 py-2 rounded hover:bg-yellow-300">
            Torneio Oficial (Dupla)
          </Link>
          <Link to="/inscricao-oficial?tipo=trio" className="bg-yellow-400 text-blue-900 py-2 rounded hover:bg-yellow-300">
            Torneio Oficial (Trio)
          </Link>
          <Link to="/inscricao-oficial?tipo=quarteto" className="bg-yellow-400 text-blue-900 py-2 rounded hover:bg-yellow-300">

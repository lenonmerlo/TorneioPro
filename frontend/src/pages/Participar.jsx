...
const Participar = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] text-center px-4">
      <div className="bg-white/60 backdrop-blur-md rounded-2xl p-8 shadow-lg border border-white/30 max-w-md w-full space-y-6">
        <img src={LogoTorneioPro} alt="Logo TorneioPro" className="w-20 h-20 mx-auto" />
        <h3 className="text-xl font-bold text-blue-800">
          Bem-vindo(a). Participe do <span className="text-yellow-600">TorneioPro</span>
        </h3>
        ...
        <div className="grid gap-3">
          ...
          <Link
            ...
            className="bg-yellow-400 text-blue-900 py-2 rounded hover:bg-yellow-300 transition"
          >
            Inscrição em Dupla
          </Link>
          <Link
            to="/inscricao-oficial?tipo=quarteto"
            className="bg-purple-700 text-white py-2 rounded hover:bg-purple-400 transition"
          >
            Inscrição em Quarteto
          </Link>
        </div>
      </div>
    </section>

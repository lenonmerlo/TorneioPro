...
// Listar torneios
export const listarTorneios = async (req: Request, res: Response): Promise<void> => {
  try {
...
// Criar torneio
export const criarTorneio = async (req: Request, res: Response): Promise<void> => { // <-- Mudei aqui
  try {
...
// Atualizar torneio
export const atualizarTorneio = async (req: Request, res: Response): Promise<void> => { // <-- Mudei aqui
...
// Deletar torneio
export const deletarTorneio = async (req: Request, res: Response): Promise<void> => { // <-- Mudei aqui
  const id = Number(req.params.id);
  try {
